...
export class LocaleHandler {
  ...
  public readonly defaultLocale: AllowedLocale;
  public readonly allowedLocales: AllowedLocale[];
  ...
  constructor(
    ...
    this.allowedLocales = this.config.allowedLocales;
  ...
  getName(locale: AllowedLocale): string {
    return this.localeNames[locale] || locale;
  }

  getFlag(locale: AllowedLocale): string {
    return this.localeFlags[locale] || "🏳️";
  }
}
