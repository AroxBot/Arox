...
export default Handler.SlashCommandHandler({
    ...
    execute: async (options, interaction) => {
        ...
        const generateEmbed = () => new EmbedBuilder()
            ...
            .setDescription(`${options._e('bank')} **${options._t("commands.bank.messages.success.bank")}** \`${interaction.user.username}\`\n\n${options._e('blank')} ${options._e('cash')} **${user.bank.toLocaleString()}**`)
            ...
            .addOptions(
                {
                    ...
                    description: options._t(
                        "commands.bank.components.select.deposit.description"
                    ),
                    value: "deposit",
                ...
                },
                {
                    ...
                    description: options._t(
                        "commands.bank.components.select.withdraw.description"
                    ),
                    value: "withdraw",
                    emoji: options._e('cash')
                }
        ...
        collector.on("collect", async (i) => {
            ...
            if (i.isStringSelectMenu()) {
                ...
                const modal = new ModalBuilder()
                    .setCustomId(`${value}_modal`)
                    .setTitle(options._t("commands.bank.modals", value, "title"));
